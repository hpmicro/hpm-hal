//! PDM FFT Spectrum Visualizer (DMA experiment) — SSD1306 128x64 OLED
//!
//! This variant keeps OLED on blocking I2C and uses PDM DMA async read.
...
async fn main(_spawner: Spawner) -> ! {
    ...
    info!("PDM FFT OLED DMA — HPM6750EVKMINI");
    info!(
        "FFT={} pts, {}.{} Hz/bin",
        FFT_SIZE,
        FREQ_PER_BIN,
